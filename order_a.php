...
hardLog("$page: $name viewing $packet",'mobile');
...
<table align="center" width="100%" style="font-variant:small-caps; font-size:12px;" border="0">
	<tr>
    	<td>Service Type 'A' For Packet <?=$_GET[packet]?></td>
    </tr>
	<tr>

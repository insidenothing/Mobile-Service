...
echo "Unlinking affidavit item #$key<br>";
		...
		$wizard="UNLINKED - ".$d[wizard];
		$action_type="UNLINKED";
		@mysql_query("update ps_history set wizard='$wizard', action_type='$action_type' where history_id = '$key'"); 
}
?>
Done!<br />
